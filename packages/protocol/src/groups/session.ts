      ...
      HttpApiEndpoint.get("session.diff", "/api/session/:sessionID/diff", {
        ...
        query: Schema.Struct({
          messageID: Schema.optional(SessionMessage.ID).annotate({
            description: "User message whose turn to diff. Defaults to the newest user message.",
          }),
