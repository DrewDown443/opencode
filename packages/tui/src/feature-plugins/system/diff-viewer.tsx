...
/** Branch comparisons resolve a review base; the working copy and session turn do not. */
...
function DiffViewer(props: { context: Plugin.Context }) {
  ...
  const diffInput = createMemo(() => ({
    ...
    location: location(),
    key: baseKey(),
    selected: needsBase(mode()) ? selectedBase() : undefined,
    sessionID: mode() === "turn" ? sessionID() : undefined,
  }))
