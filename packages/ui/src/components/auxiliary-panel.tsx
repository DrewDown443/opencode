...
export function AuxiliaryPanel(
  ...
  return (
    <aside
      ref={props.ref}
      id={props.id ?? "auxiliary-panel"}
      data-slot="auxiliary-panel"
      data-component={props["data-component"] ?? "auxiliary-panel"}
      ...
      style={{ height: props.height, "--auxiliary-panel-height": props.contentHeight }}
    >
      <div
