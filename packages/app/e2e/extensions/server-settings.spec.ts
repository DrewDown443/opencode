...
test("server extension settings remain available without a native manager", async ({ page }, info) => {
  await mockOpenCodeServer(page, { sessions: fixture.sessions, provider: fixture.provider, directory: fixture.directory, project: fixture.project, pageMessages: () => ({ items: [] }) })
  ...
  await page.screenshot({ path: info.outputPath("extensions-before.png") })
})
